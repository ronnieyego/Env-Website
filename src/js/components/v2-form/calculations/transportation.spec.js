...
const EXPECTED_OBJECT_KEYS = ['totalCo2', 'car', 'bus', 'plane', 'train', 'carBuild'];
 ...
 describe('Transportation', () => {
    ...
    it('should calculate electric cars', done => {
        const expected = { car: 10, carBuild: 47210, bus: 62, train: 39, plane: 289, totalCo2: 400 };
    ...
    it('should calculate not carpooling', done => {
        const expected = { car: 118, carBuild: 47210, bus: 62, train: 39, plane: 289, totalCo2: 508 };
    ...
    it('should calculate a rugged car', done => {
        const expected = { car: 88, carBuild: 54903, bus: 62, train: 39, plane: 289, totalCo2: 478 };
    ...
    it('should calculate a low Mpg car', done => {
        const expected = { car: 221, carBuild: 47210, bus: 62, train: 39, plane: 289, totalCo2: 611 };
    ...
    it('should calculate a heavy driver', done => {
        const expected = { car: 588, carBuild: 47210, bus: 62, train: 39, plane: 289, totalCo2: 978 };
    ...
    it('should calculate a heavy flier', done => {
        const expected = { car: 88, carBuild: 47210, bus: 62, train: 39, plane: 770, totalCo2: 959 };
    ...
    it('should calculate a heavy bus user', done => {
        const expected = { car: 88, carBuild: 47210, bus: 187, train: 39, plane: 289, totalCo2: 603 };
    ...
    it('should calculate a heavy train user', done => {
        const expected = { car: 88, carBuild: 47210, bus: 62, train: 116, plane: 289, totalCo2: 555 };
    ...
    it('should calculate a no public transit', done => {
        const expected = { car: 88, carBuild: 47210, bus: 0, train: 0, plane: 289, totalCo2: 377 };
    ...
    it('should calculate a large SUV', done => {
        const expected = { car: 88, carBuild: 73049, bus: 62, train: 39, plane: 289, totalCo2: 478 };
