		...
		return (
            <div className="costs">
                ...
                <div>
                    ...
                    <p className="costs-form-bottom-paragraph">Calculating usage CO<sub>2</sub> is pretty straightforward.  Its simply how many gallons of gas you consume (miles/mpg) times the CO<sub>2</sub> for each gallon of gas (about 20 pounds/gallon).</p>
