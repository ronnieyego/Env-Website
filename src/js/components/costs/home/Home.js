            ...
            <div className="costs">
                ...
                <div>
                    <div className="costs-form-sub-header">
                        <span>
                            This house will emit <HowMuchCo2 co2={this.props.totalCo2} /> pounds of CO<sub>2</sub>.
                        </span>         
                    </div>
                    ...
                    <BarChart graphData={this.props.graphData} units={'Pounds of CO2'} title={"CO2 breakdown of your Home"} defaultMax={20} compare={false} dataKey={'Breakdown'} />
                    ...
                    <div>
                        ...
                        <p className="costs-form-bottom-paragraph">You can greatly reduce your CO<sub>2</sub> in the demolition phase.  Most remodelers and renovaters demolish the house/room.  However, in many cases, its possible to reclaim the materials and reuse them.  Up to ~20% of the house's CO<sub>2</sub> can be reclaimed through this.</p>
                    </div>
                    <div>
                        ...
                        <p className="costs-form-bottom-paragraph">For a house, I'm assuming that the transportation CO2 is pretty insignificant (~1% in a city.  Larger for rural houses, but I'm guessing its still not more than 2%).  For apartments, I'm estimating a 2% savings vs the same house.  This comes from efficiencies in construction tools and workers.</p>
                    </div>
                </div>
            </div>
		);
