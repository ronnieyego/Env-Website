...
const section = {marginLeft: '15px', textAlign: 'left'};
const subSection = {marginLeft: '30px'};
	...
	render() {
		return (
			<div className="container-fluid text-center" >
				<Header />
				<h1 style={header}>How the Footprint Form Works</h1>
                <div style={section}>
                ...
                <div id="how-the-form-works-overview" style={section}>
                ...
                <div id="how-the-form-works-food" style={section}>
                    <h3>Food</h3>
                ...
                <div id="how-the-form-works-transportation" style={section}>
                    <h3>Transportation</h3>
                    <p>Getting data for transit data was really simple.  Most data came from the EPA or Wikipedia (yes Wikipedia).  The EPA had figures such as CO<sub>2</sub> per gallon of gas or jet fuel.  Wikipedia has great data on electric car energy use per 100 mi (I did a skewed average towards more popular models.  Telsa has the best ratio btw.) and average mpg per person for different plane models.  Overall, I found no data inconsistencies.</p>
                    <p>Choosing the questions also proved pretty simple.  I will eventually add questions on bus and train use.</p>
                </div>
                <div id="how-the-form-works-problems" style={section}>
                    <h3>Innacuracies</h3>
                    ...
                    <li>Businesses</li>
                    <br />
                    <div id="how-the-form-works-stuff" style={subSection}>
                        <h4>Stuff</h4>
                    ...
                    <div id="how-the-form-works-infrastructure" style={subSection}>
                    ...
                    <div id="how-the-form-works-business" style={subSection}>
                        <h4>Businesses</h4>
