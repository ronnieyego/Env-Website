                ...
                <div className="container-fluid text-center" >
                    ...
                    <div className="static-page">
                        ...
                        <div id="how-the-form-works-energy" className="static-page-section">
                            <h3>Energy</h3>
                            <p>As a preference, I've tried to get as much data as I can from the US government, specifically the EIA.  The EIA pretty much has everything you could ever want in terms of energy production and it is largely consistent within itself (I'll touch on data consistency later).  The main data source I've used has been a report with every state's total energy generation and emissions broken down by energy source.  I filtered sources based on whether they were commercial or utility to comprise each state's energy profile.</p>
